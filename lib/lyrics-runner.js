...
// Gantilah variabel impor tadi dengan variabel penampung lokal:
let voicePlayer = null;
let chatCache = null;

/**
 * Mendaftarkan dependensi player dan cache dari aplikasi utama.
 */
export function setLyricsRunnerDeps(deps = {}) {
  if (deps.voicePlayer) voicePlayer = deps.voicePlayer;
  if (deps.chatCache) chatCache = deps.chatCache;
}
