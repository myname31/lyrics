...
const { getCachedLyrics, setCachedLyrics, lyricsCacheKey, clearLyricsCacheForTrack, getLyricsCacheInfo } = require('./lyrics-cache.js');
const { getLyrics: lrclibGetLyrics } = require('./providers/lrclib-provider.js');
const { getLyrics: neteaseGetLyrics } = require('./providers/netease-provider.js');
const { getLyrics: scrapeGetLyrics } = require('./providers/scrape-provider.js');
 ...
 */
async function getLyrics(track, options = {}) {
 ...
 */
async function prefetchLyrics(track) {
  try {
    if (config.lyricsDebug) {
